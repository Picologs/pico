/**
 * Unified notification types for shared components
 *
 * This provides a consistent notification API across all components,
 * supporting both simple and advanced notification scenarios.
 */
